...
def lambda_handler(event, context):
    try:
        ...
        filter_query = params.get("filter")     # e.g., "metric_year==2020 and metric_value>1000"
        columns = params.get("columns")         # e.g., "company_name,metric_value,metric_year"
        order_by = params.get("order_by")       # e.g., "metric_year desc, company_name"
        ...
        if order_by:
            ...
            for item in order_items:
                ...
                ascending.append(False if len(parts) > 1 and parts[1].lower() == "desc" else True)
